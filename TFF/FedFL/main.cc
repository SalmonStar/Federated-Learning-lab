...
void RunServer() {
  ...
  LOG(INFO) << "FedFL Confidential Transform Server listening on "
            << server_address << "\n";
  ...
  server->Wait();
   ...
   // confidential_federated_compute::fed_fl

int main(int argc, char** argv) {
  confidential_federated_compute::fed_fl::RunServer();
  return 0;
}
